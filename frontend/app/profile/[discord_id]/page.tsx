                  ...
                  {(gameStats.steam?.cs2_stats || gameStats.steam?.faceit) && <article className={styles.gameCard}>
                    <div className={styles.gameCardHeader}>
                      <div>
                        ...
                        <h3 className={styles.gameCardTitle}>{cs2View === 'faceit' ? (gameStats.steam.faceit?.profile?.nickname || 'FACEIT профиль') : (gameStats.steam.profile?.username || 'Steam профиль')}</h3>
                    ...
                    <div className={styles.gameHint}>История Premier-матчей в этом профиле пока недоступна. Для CS2 сейчас доступна базовая статистика из Steam и отдельный режим FACEIT.</div>
                    </> : <div className={styles.gameHint}>Premier-статистика пока недоступна для этого аккаунта.</div>}
                    </>}
                  </article>}
