...
const SOCIAL_LINKS = [
  {
    alt: 'Twitch', href: 'https://twitch.tv/lesnayakomanda',
  ...
  {
    alt: 'Telegram', href: 'https://t.me/lesnayakomanda',
  ...
  {
    alt: 'TikTok', href: 'https://tiktok.com/@lesnayakomanda',
  ...
  {
    alt: 'YouTube', href: 'https://youtube.com/@lesnayakomanda',
  ...
  return (
    <footer className={styles.footer} id="social">
      ...
      <div className={styles.bottom}>
        <span className={styles.copy}>© {new Date().getFullYear()} Лесная Команда. Все права защищены.</span>
      </div>
    </footer>
  )
}
